...
{
    unused = system("xterm -e 'sudo ./O-Tools &>/dev/null'");
}
...
void OTools::prepareDevice4PartitionUpdate() {
    ...
    unused = system("adb reboot recovery");
    ...
    /* Assume parted, make2fs and tune2fs are present in /sbin
       ...
       in recovery */
    unused = system("adb shell \"umount /sdcard; umount /emmc; umount /data; umount /dev/block/mmcblk0p29; umount /dev/block/mmcblk0p22;\"");

    /* Now we run parted with -s and pray it works ! */
    unused = system("adb shell \"parted -s /dev/block/mmcblk0 rm 30; parted -s /dev/block/mmcblk0 rm 29;"
                       "parted -s /dev/block/mmcblk0 rm 28; parted -s /dev/block/mmcblk0 rm 27 \"");
    unused = system("adb shell \"parted -s /dev/block/mmcblk0 rm 26; parted -s /dev/block/mmcblk0 rm 25;"
                       "parted -s /dev/block/mmcblk0 rm 24; parted -s /dev/block/mmcblk0 rm 23 \"");
    unused = system("adb shell \"parted -s /dev/block/mmcblk0 rm 22; parted -s /dev/block/mmcblk0 rm 21;"
...
void OTools::postPartitionProcessing() {
    ...
    unused = system("adb shell \"mke2fs -t ext4 -m 0 -L userdata /dev/block/mmcblk0p20;"
    ...
    unused = system("adb shell \"mke2fs -t ext4 -m 0 -L cache /dev/block/mmcblk0p22;"
    ...
    unused = system("adb push find5/mmcblk0p21_persist_ext4.img /sdcard/");
    unused = system("adb push find5/recovery.img /sdcard/");
    unused = system("adb shell \"dd if=/sdcard/mmcblk0p21_persist_ext4.img of=/dev/block/mmcblk0p21;"
...
*/
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 2588672s 15171583s;"
            ...
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 16236544s 16238591s;"
            ...
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 16351232s 16367615s;"
...
*/
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 2588672s 17268735s;"
                               "parted -s /dev/block/mmcblk0 name 20 userdata;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 22 cache \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 18333696s 18335743s;"
                               "parted -s /dev/block/mmcblk0 name 23 misc;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 25 reserve1 \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 18448384s 18464767s;"
                               "parted -s /dev/block/mmcblk0 name 26 reserve2;"
...
*/
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 2588672s 19365887s;"
                               "parted -s /dev/block/mmcblk0 name 20 userdata;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 22 cache \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 20430848s 20432895s;"
                               "parted -s /dev/block/mmcblk0 name 23 misc;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 25 reserve1 \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 20545536s 20561919s;"
                               "parted -s /dev/block/mmcblk0 name 26 reserve2;"
...
*/
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 2588672s 21463039s;"
                               "parted -s /dev/block/mmcblk0 name 20 userdata;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 22 cache \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 22528000s 22530047s;"
                               "parted -s /dev/block/mmcblk0 name 23 misc;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 25 reserve1 \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 22642688s 22659071s;"
                               "parted -s /dev/block/mmcblk0 name 26 reserve2;"
...
*/
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 2588672s 23560191s;"
                               "parted -s /dev/block/mmcblk0 name 20 userdata;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 22 cache \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 24625152s 24627199s;"
                               "parted -s /dev/block/mmcblk0 name 23 misc;"
                               ...
                               "parted -s /dev/block/mmcblk0 name 25 reserve1 \"");
            unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 24739840s 24756223s;"
                               "parted -s /dev/block/mmcblk0 name 26 reserve2;"
...
*/
        unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 2588672s 6782975s;"
                           "parted -s /dev/block/mmcblk0 name 20 userdata;"
                           "parted -s /dev/block/mmcblk0 mkpart primary 6782976s 6799359s;"
                           "parted -s /dev/block/mmcblk0 name 21 persist;"
                           "parted -s /dev/block/mmcblk0 mkpart primary 6799360s 7847935s;"
                           "parted -s /dev/block/mmcblk0 name 22 cache \"");
        unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 7847936s 7849983s;"
                           "parted -s /dev/block/mmcblk0 name 23 misc;"
                           "parted -s /dev/block/mmcblk0 mkpart primary 7864320s 7884799s;"
                           "parted -s /dev/block/mmcblk0 name 24 recovery;"
                           "parted -s /dev/block/mmcblk0 mkpart primary 7897088s 7962623s;"
                           "parted -s /dev/block/mmcblk0 name 25 reserve1 \"");
        unused = system("adb shell \"parted -s /dev/block/mmcblk0 mkpart primary 7962624s 7979007s;"
                           "parted -s /dev/block/mmcblk0 name 26 reserve2;"
